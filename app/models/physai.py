...
class GraphSolver():
    ...
    # Check incomming graph from the front end
    def Check(self):
        ...
        for i in self.G.nodes():
            if ('state' in self.G.nodes[i]) and (self.G.nodes[i]['state'] == 'solution'):
    ...
    # One shot solution using symbolic solver from scipy
