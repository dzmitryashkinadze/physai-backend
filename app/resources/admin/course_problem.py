...
from app.models.course_problem import CourseProblemModel
from flask import Response, json
from app.decorators import auth_required


class AdminCourseProblem(Resource):
    """
    ...
    def get(user, self, id):
        ...
        raw = CourseProblemModel.find_by_id(int(id))
        if raw:
            return raw.json()
    ...
    def put(user, self, id):
        ...
        data = AdminCourseProblem.parser.parse_args()
        raw = CourseProblemModel.find_by_id(int(id))
        if raw:
            raw.update(**data)
        else:
...
class AdminCourseProblemList(Resource):
    """
    This resource is used to get, update and delete equations.
    """
    ...
    def get(user, self):
        ...
        data = list(map(lambda x: x.json(), CourseProblemModel.query.all()))
