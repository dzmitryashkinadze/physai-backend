...
from app.models.problem_tag import ProblemTagModel
from flask import Response, json
from app.decorators import auth_required


class AdminProblemTag(Resource):
    """
    ...
    def get(user, self, id):
        ...
        raw = ProblemTagModel.find_by_id(int(id))
        if raw:
            return raw.json()
    ...
    def put(user, self, id):
        ...
        data = AdminProblemTag.parser.parse_args()
        raw = ProblemTagModel.find_by_id(int(id))
        if raw:
            raw.update(**data)
        else:
...
class AdminProblemTagList(Resource):
    """
    This resource is used to get, update and delete equations.
    """
    ...
    def get(user, self):
        ...
        data = list(map(lambda x: x.json(), ProblemTagModel.query.all()))
